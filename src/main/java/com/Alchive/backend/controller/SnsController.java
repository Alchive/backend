...
import static com.Alchive.backend.config.result.ResultCode.SNS_CREATE_SUCCESS;
import static com.Alchive.backend.config.result.ResultCode.SNS_INFO_SUCCESS;
