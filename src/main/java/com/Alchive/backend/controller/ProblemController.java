...
public class ProblemController {
    ...
    public ResponseEntity<ApiResponse> getProblemPlatform(@RequestParam(required = true, name = "p") @Schema(description = "Algorithm Platform") String platform) {
        List<ProblemListResponseDTO> problemData = problemService.getProblemsByPlatform(platform);
    ...
    public ResponseEntity<ApiResponse> getProblemSearch(
            ...
            Long userId,
            @RequestParam(required = true, name = "k")
            @Schema(description = "검색 내용")
            String keyword,
            @RequestParam(required = true, name = "c")
